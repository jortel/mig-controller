...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PlanRefResources) DeepCopyInto(out *PlanRefResources) {
	*out = *in
	if in.MigPlan != nil {
	...
	if in.SrcBackup != nil {
		in, out := &in.SrcBackup, &out.SrcBackup
		*out = new(velerov1.Backup)
		(*in).DeepCopyInto(*out)
	}
	if in.DestRestore != nil {
		in, out := &in.DestRestore, &out.DestRestore
		*out = new(velerov1.Restore)
		(*in).DeepCopyInto(*out)
	}
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PlanRefResources.
func (in *PlanRefResources) DeepCopy() *PlanRefResources {
	if in == nil {
		return nil
	}
	out := new(PlanRefResources)
	in.DeepCopyInto(out)
	return out
}
